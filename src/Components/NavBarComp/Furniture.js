...
import FurnitureApi from '../Json/Furniture.json'
...
function Furniture() {
  ...
  const [data] = useState(FurnitureApi);

  return (
    <div className="container-fluid">

      <Helmet>
        <title>Flipkart | Furniture</title>
      </Helmet>
